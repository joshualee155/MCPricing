...
ConstantElasticityVarianceProcess::ConstantElasticityVarianceProcess(double _X0, double _mu, double _vol, double _beta):StochProcess(_X0), mu(_mu), vol(_vol), beta(_beta)
{}
